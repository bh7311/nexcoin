...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Nexcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"nexcointools.com", "192.169.0.120"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"nexcointools.com", "testnet-seed.nexcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Nexcoin is probably already running."), addrBind.ToString().c_str());
        else
